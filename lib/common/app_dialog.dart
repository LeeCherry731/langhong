...
class AppDialog {
          ...
          child: Material(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Container(
                      child: Image.asset('assets/images/info-warning.png',
                          height: 70, width: 70)),
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        child: Text('ใช่', style: AppFont.btnText09),
                      ...
                      ElevatedButton(
                        child: Text('ไม่', style: AppFont.btnText09),
                        style: ElevatedButton.styleFrom(
  ...
  static refreshLoginDialog(BuildContext context, IO.Socket socket,
      int levelMsg, String message) async {
    await showDialog(
      context: context,
      barrierDismissible: true,
      builder: (context) {
